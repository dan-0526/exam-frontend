<template>
    ...
    <a-typography style="text-align: left;">
        ...
        <a-typography-title :level="4">7.考卷批阅</a-typography-title :level="4">
        ...
        <a-typography-title :level="4">8.成绩模块</a-typography-title :level="4">
        <a-typography-paragraph>
            参加考试后的学生用户，在提交试卷后进入考试结果页面，页面会自动核对学生用户的逻辑题的对错，对于简答题需要老师或者超级管理员进行批阅。对于学生用户参与的考试，学生用户可以查看到考试的详情并可以查看到自己所错的逻辑题。
        </a-typography-paragraph>
        <a-typography-title :level="4">9.考试统计</a-typography-title :level="4">
